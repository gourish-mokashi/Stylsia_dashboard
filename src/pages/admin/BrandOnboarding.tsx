      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-1">Error loading onboarding data</p>
          </div>
        </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-xs text-gray-500">+{stats.thisWeekApplications} this week</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-xs text-gray-500">Avg. {stats.averageReviewTime} days</p>
              </div>
            </div>
          </div>
...
function BrandCard({ 
  ...
  return (
    <div className="p-3 bg-gray-50 rounded-lg border border-gray-200 hover:shadow-md transition-shadow cursor-pointer relative">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-900">{new Date(brand.appliedDate).toLocaleDateString()}</p>
                </div>
              </div>
