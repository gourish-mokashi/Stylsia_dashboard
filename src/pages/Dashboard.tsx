      ...
      <div className="mt-6 space-y-6">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 animate-slide-up">
          <div className="p-4 sm:p-6">
            <h2 className="text-fluid-lg font-semibold text-gray-900 mb-4">
              Quick Actions
            </h2>
            ...
            <div className="sr-only">
              <div id="view-products-description">
                Navigate to your products page to view and manage all your
                listed products.
              </div>
              <div id="view-analytics-description">
                Access comprehensive analytics including click rates, views, and
        ...
        {!isLoading &&
          !hasError &&
          (!brandWithMetrics?.metrics?.total_products ||
            brandWithMetrics.metrics.total_products === 0) && (
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 animate-slide-up">
              <div className="p-4 sm:p-6 text-center">
                <FileText className="h-12 w-12 text-gray-400 mx-auto mb-4" />
                <h2 className="text-fluid-lg font-semibold text-gray-900 mb-2">
                  Welcome to Partner Dashboard
                </h2>
                <p className="text-gray-600 mb-6 max-w-md mx-auto">
                  Your products will appear here once they are added to our
                  platform. Contact our team to get started with product
                  listings.
                </p>
            ...
            <div className="p-4 sm:p-6">
              ...
              <div className="space-y-4">
                {announcements.map((announcement, index) => (
                  ...
                  >
                    <h3 className="font-medium text-gray-900 text-fluid-base">
                      {announcement.title}
                    </h3>
                    <p className="text-fluid-sm text-gray-600 mt-1 leading-relaxed">
