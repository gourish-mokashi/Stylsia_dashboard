...
export default function Analytics() {
  ...
  const { analytics, loading, error, filters, setFilters, refreshData } =
    useAnalyticsData({
      period:
        dateRange === "7d"
          ? "day"
  ...
  const hasData = analytics?.overview?.total_products
      ...
      <div className="mt-6 space-y-6">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <Button icon={Download} disabled={!hasData}>
              Export Data
            </Button>
          </div>
        </div>
        ...
        {!hasData && (
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-12 text-center">
            ...
            <p className="text-gray-600 mb-4">
              Analytics will appear here once you have products and they start
              receiving views and clicks.
            </p>
            <div className="text-sm text-gray-500">
              ...
              <ul className="mt-2 space-y-1">
                ...
                <li>
                  • Analytics will populate as users interact with your products
                </li>
              </ul>
            </div>
          </div>
            ...
            {topProducts.length > 0 ? (
              ...
              <div className="text-center py-8 text-gray-500">
                ...
                <p className="text-sm mt-1">
                  Data will appear once your products receive interactions
                </p>
              </div>
            )}
          </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          {!hasData && (
            <div className="mt-4 text-center text-sm text-gray-500">
              All metrics will update automatically as your products gain
