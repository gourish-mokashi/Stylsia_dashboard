      ...
      <div className="w-full max-w-md mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-xl shadow-2xl p-6 sm:p-8 animate-scale-in">
          ...
          <div className="text-center mb-6 sm:mb-8">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">Admin Portal</h2>
            <p className="mt-2 text-sm sm:text-base text-gray-600">Stylsia Administration Dashboard</p>
          </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all duration-200 text-base"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-12 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all duration-200 text-base"
